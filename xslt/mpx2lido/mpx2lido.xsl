...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/mpx:museumPlusExport/mpx:sammlungsobjekt">
        ...
        <lido:lido>
            <lido:lidoRecID lido:type="local">spk:obj-<xsl:value-of select="@objId"/></lido:lidoRecID>
            <lido:descriptiveMetadata xml:lang="de">
                <lido:objectClassificationWrap>
                    <lido:objectWorkTypeWrap>
                        <lido:objectWorkType>
                            <lido:term>
                                <xsl:value-of select="child::mpx:objekttyp"/>
                            </lido:term>
                        </lido:objectWorkType>
                    </lido:objectWorkTypeWrap>
                ...
                <lido:objectIdentificationWrap>
                    ...
                    <lido:repositoryWrap>
                        <lido:repositorySet lido:repositoryType="current">
            ...
            <lido:administrativeMetadata xml:lang="de">
                <lido:rightsWorkWrap>
                    <lido:rightsWorkSet>
                        <lido:rightsType xml:lang="en">to be specified</lido:rightsType>
                        <lido:rightsHolder>
                            <lido:legalBodyName>
                                <!-- Sollte hier ein mpx-Feld verwendet werden? -->
                                <lido:appellationValue xml:lang="de">Staatliche Museen zu Berlin,
                                    Stiftung Preussischer Kulturbesitz</lido:appellationValue>
                            </lido:legalBodyName>
                        </lido:rightsHolder>
                    </lido:rightsWorkSet>
                </lido:rightsWorkWrap>
                <lido:recordWrap>
                    ...
                    <lido:recordType xml:lang="en">item</lido:recordType>
                ...
                <lido:resourceWrap>
                    <xsl:for-each
                        ...
                        <lido:resourceSet>
                            ...
                            <lido:rightsResource>
                                <lido:rightsType>Alle Rechte vorbehalten.</lido:rightsType>
                            </lido:rightsResource>
                            <lido:rightsResource>
                                <lido:creditLine>
                            ...
                            <lido:resourceViewDescription>Harpe arquée "kundi", anonyme, vers 1920,
                                E.999.10.1, vue de face - Jean-Marc
                            Anglès</lido:resourceViewDescription>
                        </lido:resourceSet>
                    </xsl:for-each>
                </lido:resourceWrap>
